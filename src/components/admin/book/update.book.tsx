...
import { getCategoryAPI, uploadFileAPI, updateBookAPI } from "@/services/api";
...
interface IProps {
  ...
  setDataUpdate: (data: IBookTable | null) => void;
}
    ...
    try {
      ...
      if (response?.data) {
        ...
        notification.error({
          ...
          description:
            response.message || "Failed to update book. Please try again!",
        });
      }
    } catch (error: any) {
      const errorMessage =
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Form.Item labelCol={{ span: 24 }} label="Thumbnail">
          <Upload
        ...
        <Form.Item labelCol={{ span: 24 }} label="Slider Images">
          <Upload
            listType="picture-card"
            maxCount={8}
